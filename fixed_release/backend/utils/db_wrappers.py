"""
Database Wrappers with Performance Profiling
Профилируемые обертки над репозиториями для мониторинга производительности
"""
...
async def find_pending_order(telegram_id: int, projection: dict = None):
    ...
    from server import db  # Will be available after import
